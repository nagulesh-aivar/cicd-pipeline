...
class EntityMessages:
    ...
    SEARCH_SUCCESS = "Found {count} entities where {column} matches '{value}'"
    NO_SEARCH_RESULTS = "No entities found where {column} matches '{value}'"
    ...
    INVALID_SEARCH_COLUMN = "Invalid search column: {column}. Allowed columns: {allowed}"
    ...
    SEARCH_ERROR = "Error searching entities: {error}"
...
class VendorMessages:
    ...
    SEARCH_SUCCESS = "Found {count} vendors where {column} matches '{value}'"
    NO_SEARCH_RESULTS = "No vendors found where {column} matches '{value}'"
    ...
    SEARCH_ERROR = "Error searching vendors: {error}"
...
class ClientRuleMessages:
    ...
    SEARCH_SUCCESS = "Found {count} rules matching search criteria"
    SEARCH_NO_RESULTS = "No rules found matching search criteria"
    ...
    SEARCH_ERROR = "Error searching client rules: {error}"
...
class WorkflowExecutionLogMessages:
    ...
    SEARCH_SUCCESS = "Found {count} workflow execution logs matching search criteria"
    SEARCH_NO_RESULTS = "No workflow execution logs found matching search criteria"
    ...
    SEARCH_ERROR = "Error searching workflow execution logs: {error}"
...
class AgentExecutionLogMessages:
    ...
    SEARCH_SUCCESS = "Found {count} agent execution logs matching search criteria"
    SEARCH_NO_RESULTS = "No agent execution logs found matching search criteria"
    ...
    SEARCH_ERROR = "Error searching agent execution logs: {error}"
    UPDATE_ERROR = "Error updating agent execution log: {error}"
    DELETE_ERROR = "Error deleting agent execution log: {error}"

class NotificationMessages:
    # ---- Template Messages ----
    TEMPLATE_LIST_SUCCESS = "{count} templates found"
    TEMPLATE_RETRIEVED_SUCCESS = "Template '{name}' retrieved successfully"
    TEMPLATE_NOT_FOUND = "Template '{name}' not found"
    TEMPLATE_CREATE_SUCCESS = "Template '{name}' created successfully"
    TEMPLATE_UPDATE_SUCCESS = "Template '{name}' updated successfully"
    TEMPLATE_DELETE_SUCCESS = "Template '{name}' deleted successfully"
    TEMPLATE_PROCESSING_ERROR = "Error while processing template: {error}"

    # ---- Notification Send Messages ----
    NOTIFICATION_SENT_SUCCESS = "{channel} sent successfully"
    INVALID_CHANNEL = "Invalid channel. Supported: email, sms, whatsapp, notification"
    TEMPLATE_VARIABLE_ERROR = "Missing or invalid template variables"

    # ---- Email Messages ----
    EMAIL_SEND_ERROR = "Failed to send email via SES: {error}"

    # ---- SMS Messages ----
    SMS_SEND_ERROR = "Failed to send SMS via EUM API: {error}"
    SMS_API_ERROR = "EUM SMS API returned an error: {error}"

    # ---- WhatsApp Messages ----
    WHATSAPP_SEND_ERROR = "Failed to send WhatsApp message: {error}"
    WHATSAPP_API_ERROR = "WhatsApp API returned an error: {error}"

class EmailMessages:
    TEMPLATE_CREATED_SUCCESS = "Email template '{name}' created successfully."
    TEMPLATE_CREATE_ERROR = "Error creating email template: {error}"
    TEMPLATE_LIST_SUCCESS = "{count} templates retrieved successfully."
    TEMPLATE_LIST_ERROR = "Error listing email templates: {error}"
    TEMPLATE_RETRIEVED_SUCCESS = "Email template '{name}' retrieved successfully."
    TEMPLATE_RETRIEVE_ERROR = "Error retrieving email template: {error}"
    TEMPLATE_UPDATED_SUCCESS = "Email template '{name}' updated successfully."
    TEMPLATE_UPDATE_ERROR = "Error updating email template: {error}"
    TEMPLATE_DELETED_SUCCESS = "Email template '{name}' deleted successfully."
    TEMPLATE_DELETE_ERROR = "Error deleting email template: {error}"
    TEMPLATE_NOT_FOUND = "Email template '{name}' not found."
...
class TransactionLogMessages:
    """Messages for Transaction Log operations"""
    
    # Success messages
    RETRIEVED_SUCCESS = "Transaction log retrieved: {id}"
    RETRIEVED_ALL_SUCCESS = "Retrieved {count} transaction logs"
    
    # Error messages
    NOT_FOUND = "Transaction log with ID {id} not found"
    RETRIEVE_ERROR = "Error retrieving transaction log: {error}"
    RETRIEVE_ALL_ERROR = "Error retrieving transaction logs: {error}"
